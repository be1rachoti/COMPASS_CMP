...
Says what stopped and what did not, because the distinction is the one people get
wrong: withdrawing stops future processing for those purposes, and does not by
itself delete what was already collected. Erasure is a separate request, and the
message says so rather than letting somebody assume.
"""
